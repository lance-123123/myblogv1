                ...
                <div class="widget">
                    ...
                    <div class="widget-body">
                        <div class="row">
                            ...
                            <form method="post" id="form" action="<?php echo U('Mangement/submit_type');?>" role="form">
                                <div class="form-group">
                                    <label>类型</label>
                                    <input class="form-control" name="title" placeholder="类型名称最多只能13个字"  maxlength="13" id="title">
                                </div>

                                <div class="form-group">
                                    <textarea id="description" style="resize:none;width:100%" placeholder="请输入类型的描述" cols="90" rows="6"></textarea>
                                </div>
...
<script type="text/javascript">
   ...
   /* var root = '/myblogv1';
    ...
    var action = "/myblogv1/index.php/Admin/Mangement/add_blog_type";
