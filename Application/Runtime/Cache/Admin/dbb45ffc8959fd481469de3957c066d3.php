            ...
            <div class="col-xs-12 col-md-12">
                <div class="widget">
                    <div class="widget-header ">
                        <span class="widget-caption"><i class="fa fa-globe"></i>&nbsp;&nbsp;修改密码</span>
                    </div>
                    <div class="widget-body">
                       <div class="row">
                            <div class="col-lg-12 col-sm-12 col-xs-12">
                            <form method="post" id="form" action="<?php echo U('Personal/submit_pwd');?>" role="form">
                                <div class="form-group">
                                    <label>新密码</label>
                                    <input class="form-control" type="password" name="pwd" placeholder="请输入新密码"  maxlength="13" id="pwd">
                                </div>

                                <div class="form-group">
                                   <label>确认新密码</label>
                                   <input class="form-control" type="password" name="title" placeholder="请输入确认新密码"  maxlength="13" id="req_pwd">
                                </div>
...
<script type="text/javascript">
   ...
   /* var root = '/myblogv1';
    ...
    var controll = "/myblogv1/index.php/Admin/Personal";
    var action = "/myblogv1/index.php/Admin/Personal/user";
...
<script type="text/javascript" src="/myblogv1/Public/admin/js/submit_user.js"></script>
