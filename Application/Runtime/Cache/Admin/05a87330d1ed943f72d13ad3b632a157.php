            ...
            <div class="col-xs-12 col-md-12">
                <div class="widget">
                    <div class="widget-header ">
                        <span class="widget-caption"><i class="fa fa-globe"></i>&nbsp;&nbsp;图片管理</span>
                    </div>
                    <div class="widget-body">

                     <div class="btn-group">
                            <button type="button" class="btn btn-default btn-add"
                                    data="<?php echo U('Photo/add_photo');?>"><i
                                    class="fa fa-plus-square"></i> 新增
                            </button>
                            <button type="button" class="btn btn-default btn-edit"
                                    data="<?php echo U('admin/Photo/show_edit_photo');?>"><i
                                    class="fa fa-pencil-square"></i> 编辑
                            </button>
                            <button type="button" class="btn btn-default btn-del"
                                    data="<?php echo U('admin/Photo/del_photos');?>"><i
                                    class="fa fa-minus-square"></i> 删除
                            </button>
                            <input type="hidden" id="changes" value="<?php echo U('admin/Photo/change_status');?>">
                        </div>
                        ...
                        <div role="grid" id="simpledatatable_wrapper" class="dataTables_wrapper form-inline no-footer">
                            ...
                            <input type="hidden" id="data" value="<?php echo U('Photo/get_photo_data');?>">
                    </div>
                </div>
            </div>
...
<script type="text/javascript">
   ...
   /* var root = '/myblogv1';
    ...
    var action = "/myblogv1/index.php/Admin/Photo/show_photo";
...
<script type="text/javascript" src="/myblogv1/Public/admin/js/show_photo.js"></script>
