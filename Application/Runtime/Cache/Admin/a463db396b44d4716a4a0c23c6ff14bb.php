            ...
            <div class="col-xs-12 col-md-12">
                <div class="widget">
                    ...
                    <div class="widget-body">
                        <div class="row">
                            <input type="hidden" value="<?php echo U('Mangement/type_manage');?>" id="blog_path">
                            ...
                            <form method="post" id="form" action="<?php echo U('Mangement/submit_type_edit');?>" role="form">
                            <input type="hidden" value="<?php echo ($blog_type_list["id"]); ?>" id="ids">
                                <div class="form-group">
                                    <label>类型</label>
                                    <input class="form-control" name="title" placeholder="类型名称最多只能13个字"  maxlength="13" id="title" value="<?php echo ($blog_type_list["type_name"]); ?>">
                                </div>

                                <div class="form-group">
                                    <textarea id="description" style="resize:none;width:100%" placeholder="请输入类型的描述" cols="90" rows="6"><?php echo ($blog_type_list["descript"]); ?></textarea>
                                </div>

                                <div class="form-group" style="margin-left: 7%">
                                    <div class="row fileupload-buttonbar">
                                        <div class="thumbnail col-sm-11" align="center">
                                            <img id="weixin_show" style="height:180px;margin-top:10px;margin-bottom:8px;"  src="/myblogv1/Uploads//<?php echo ($blog_type_list["photo"]); ?>" data-holder-rendered="true">
                                ...
                                <input type="hidden" id="photourl" value="<?php echo ($blog_type_list["photo"]); ?>">
...
<script type="text/javascript">
   ...
   /* var root = '/myblogv1';
    ...
    var action = "/myblogv1/index.php/Admin/Mangement/edit_blog_type";
  ...
  /*  $(function () {
    ...
    <script type="text/javascript" src="/myblogv1/Public/admin/static/upfile/js/jquery.fileupload.js"></script>
    <script type="text/javascript" src="/myblogv1/Public/admin/js/addtype.js"></script>
    <script type="text/javascript">
