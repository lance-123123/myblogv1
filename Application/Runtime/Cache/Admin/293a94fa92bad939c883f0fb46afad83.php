                ...
                <div class="widget">
                    ...
                    <div class="widget-body">
                        <div class="row">
                            ...
                            <form method="post" id="form" action="<?php echo U('Photo/submit_add_photo');?>" role="form">
                                <div class="form-group">
                                    <label>标题</label>
                                    <input class="form-control" name="title" placeholder="图片标题最多只能13个字"  maxlength="13" id="title">
                                </div>
...
<script type="text/javascript">
   ...
   /* var root = '/myblogv1';
    ...
    var action = "/myblogv1/index.php/Admin/Photo/add_photo";
  ...
  /*  $(function () {
    ...
    <script src="/myblogv1/Public/admin/js/add_photo.js"></script>
    <script type="text/javascript">
        /*加载ue插件*/
