            ...
            <div class="col-xs-12 col-md-12">
                <div class="widget">
                    <div class="widget-header ">
                        <span class="widget-caption"><i class="fa fa-globe"></i>&nbsp;&nbsp;历史管理</span>
                    ...
                    <div class="widget-body">
                       ...
                       <div class="btn-group">
                            <button type="button" class="btn btn-default btn-add"
                                    data="<?php echo U('admin/History/add_history');?>"><i
                                    class="fa fa-plus-square"></i> 新增
                            </button>
                            <button type="button" class="btn btn-default btn-edit"
                                    data="<?php echo U('admin/History/edit_history');?>"><i
                                    class="fa fa-pencil-square"></i> 编辑
                            </button>
                            <button type="button" class="btn btn-default btn-del"
                                    data="<?php echo U('admin/History/delete_history');?>"><i
                         ...
                         <div role="grid" id="simpledatatable_wrapper" class="dataTables_wrapper form-inline no-footer">
                            ...
                            <input type="hidden" id="data" value="<?php echo U('History/get_blog_data');?>">
...
<script type="text/javascript">
   ...
   /* var root = '/myblogv1';
    ...
    var action = "/myblogv1/index.php/Admin/History/show_history";
...
<script type="text/javascript" src="/myblogv1/Public/admin/js/history_manage.js"></script>
