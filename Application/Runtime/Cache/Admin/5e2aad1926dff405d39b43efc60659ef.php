            ...
            <div class="col-xs-12 col-md-12">
                <div class="widget">
                    <div class="widget-header ">
                        <span class="widget-caption"><i class="fa fa-pencil"></i>&nbsp;&nbsp;添加图文</span>
                    ...
                    <div class="widget-body">
                        <div class="row">
                            <input type="hidden" value="<?php echo U('Photo/show_photo');?>" id="blog_path">
                            ...
                            <form method="post" id="form" action="<?php echo U('Photo/submit_edit_photo');?>" role="form">
                            <input type="hidden" id="ids" value="<?php echo ($data["id"]); ?>">
                                <div class="form-group">
                                    <label>标题</label>
                                    <input class="form-control" name="title" placeholder="图片标题最多只能13个字"  maxlength="13" id="title" value="<?php echo ($data["title"]); ?>">
                                </div>

                                <div class="form-group">
                                    <label>内容</label>
                                    <textarea id="editor" name="content"><?php echo ($data["content"]); ?>
                                    </textarea>
                                </div>
                                ...
                                <div class="form-group" style="margin-left: 7%">
                                    <div class="row fileupload-buttonbar">
                                        <div class="thumbnail col-sm-11" align="center">
                                            <img id="weixin_show" style="height:180px;margin-top:10px;margin-bottom:8px;"  src="/myblogv1/Uploads//<?php echo ($data["pthoto_url"]); ?>" data-holder-rendered="true">
                                ...
                                <input type="hidden" id="photourl" value="<?php echo ($data["pthoto_url"]); ?>">
...
<script type="text/javascript">
   ...
   /* var root = '/myblogv1';
    ...
    var controll = "/myblogv1/index.php/Admin/Photo";
    var action = "/myblogv1/index.php/Admin/Photo/show_edit_photo";
  ...
  /*  $(function () {
    ...
    <script src="/myblogv1/Public/admin/js/edit_photo.js"></script>
    <script type="text/javascript">
        /*加载ue插件*/
