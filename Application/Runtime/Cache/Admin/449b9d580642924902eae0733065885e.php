            ...
            <div class="col-xs-12 col-md-12">
                <div class="widget">
                    <div class="widget-header ">
                        <span class="widget-caption"><i class="fa fa-pencil"></i>&nbsp;&nbsp;添加历史</span>
                    ...
                    <div class="widget-body">
                        <div class="row">
                            ...
                            <form method="post" id="form" action="<?php echo U('History/submit_history');?>" role="form">
                                <div class="form-group">
                                    <label>标题</label>
                                    <input class="form-control" name="title" placeholder="历史标题最多只能13个字"  maxlength="13" id="title">
                                </div>
...
<script type="text/javascript">
   ...
   /* var root = '/myblogv1';
    ...
    var action = "/myblogv1/index.php/Admin/History/add_history";
  ...
  /*  $(function () {
    ...
    <script src="/myblogv1/Public/admin/js/add_history.js"></script>
    <script type="text/javascript">
        /*加载ue插件*/
